...
internal class NonQualifiedTeapot(Configuration configuration) : ITeapot, IStateMachine
{
    ...
    public ValueTask Launch(CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask Heat(CancellationToken cancellationToken = default)
    {
